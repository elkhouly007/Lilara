...
printf '{"session_id":"s","tool_call_id":"t","tool_name":"Bash","tool_input":{"command":"ls -la"}}' \
  | LILARA_RATE_LIMIT=0 node "$adapter" > "$tmp_stdout" 2>"$tmp_stderr" || actual_exit=$?
...
printf '{"session_id":"s","tool_call_id":"t","tool_name":"Bash","tool_input":{"command":"rm -rf /home/user/data"}}' \
  | LILARA_RATE_LIMIT=0 LILARA_ENFORCE=1 node "$adapter" > "$tmp_stdout" 2>"$tmp_stderr" || actual_exit=$?
...
printf '{"session_id":"s","tool_call_id":"t","tool_name":"Bash","tool_input":{"command":"ls"}}' \
  | LILARA_RATE_LIMIT=0 LILARA_KILL_SWITCH=1 node "$adapter" > "$tmp_stdout" 2>"$tmp_stderr" || actual_exit=$?
