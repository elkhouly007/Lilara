...
EXPECTED_SKILLS=35         # excludes agents/README.md style files
...
# ---------------------------------------------------------------------------
if grep -q "56 agents" "$root/README.md"; then
  pass "README.md mentions 56 agents"
else
  fail "README.md does not mention '56 agents' — update README.md"
fi
