...
EXPECTED_SKILLS=23         # excludes agents/README.md style files
...
# ---------------------------------------------------------------------------
if grep -q "50 agents" "$root/README.md"; then
  pass "README.md mentions 50 agents"
else
  fail "README.md does not mention '50 agents' — update README.md"
fi
