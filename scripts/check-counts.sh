...
EXPECTED_SKILLS=33         # excludes agents/README.md style files
...
# ---------------------------------------------------------------------------
if grep -q "55 agents" "$root/README.md"; then
  pass "README.md mentions 55 agents"
else
  fail "README.md does not mention '55 agents' — update README.md"
fi
