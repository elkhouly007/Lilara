...
- **94 rule files** covering 12 language directories plus common, database, infrastructure, and web domains;
...
| Rules | 0 | 94 | 94 | 12 languages + common/database/infra/web domains |
...
- **Rules**: 94 original files; 12 language domains plus common/database/infra/web; YAML frontmatter with `last_reviewed` and `version_target` on every file
