...
- executable fixture coverage with **247/247 passing**;
...
- `run-fixtures.sh` — passing (247/247)
...
> **Agent Runtime Guard is a purpose-built, all-original agentic policy and amplification framework with a verified runtime decisioning layer, comprehensive rule coverage across 12 languages, and 247 passing integration fixtures.**
