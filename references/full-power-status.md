...
- **45 skills** for ARG debug, policy tuning, capability auditing, code analysis, git workflows, architecture analysis, performance profiling, orchestration design, and more;
...
| Skills | 0 | 45 | 45 | ARG debug, policy, analysis, orchestration, git workflows, architecture, performance |
...
- **Skills**: 45 original skills spanning ARG configuration, analysis, orchestration, git workflows, architecture, performance, and amplification workflows
