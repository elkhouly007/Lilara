...
- executable fixture coverage with **384/384 passing**;
...
- `run-fixtures.sh` — passing (384/384)
...
**Test coverage added:**
- `tests/fixtures/mcp-security/` — 3 fixture files (F25, F4 opt-out, benign FP control)
...
- 384/384 fixtures passing; 94 scripts.
