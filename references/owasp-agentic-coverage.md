...
- Antegravity PostToolUse API verification (ASI05): post-adapter.js covers likely payload shapes but the upstream hook event model is unverified for this harness. Classified as DOCUMENTED LIMITATION rather than NOT COVERED. A contributor with a live Antegravity instance should confirm and remove this note. (Codex and ClawCode have been verified — see `codex/WIRING_PLAN.md` and `clawcode/WIRING_PLAN.md`.)
