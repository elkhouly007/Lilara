...
- Codex and Antegravity PostToolUse API verification (ASI05): both adapters are source-trace verified (Codex 2026-05-24 via openai/codex; Antegravity 2026-05-24 via google-gemini/gemini-cli). Live end-to-end hook fires with a real `codex` or `agy` instance are still pending; documented as re-check triggers in their respective WIRING_PLAN.md files.
