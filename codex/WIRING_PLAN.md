...
Current wiring is **PreToolUse-only**. A PostToolUse hook (`codex/hooks/post-adapter.js`) is implemented and scans output for secrets and records external reads for the taint/provenance system.
